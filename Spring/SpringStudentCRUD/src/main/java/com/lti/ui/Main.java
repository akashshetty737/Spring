...
//		ApplicationContext context = new FileSystemXmlApplicationContext("full_path_of_the_following_xml/spring-config.xml");
		ApplicationContext context = new ClassPathXmlApplicationContext("spring-config.xml");
		StudentService service = context.getBean("service", StudentService.class);
		
		//you have to receive the data from user if you want to store the real data
